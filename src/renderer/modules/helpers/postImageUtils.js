 ...
 * @param  {object} spectrogram
 * @param  {function} secToTick
 * @param  {number} noteOnNoteNumber
 */
export const parsePointAsModulation = (modulationPoint, spectrogram, secToTick, noteOnTime, noteOnNoteNumber) => {
  ...
  return {
    ...
    pitchBend: pitchAndNoteNumberToPitchBend(pitch, noteOnNoteNumber),
 ...
 * @param  {function} secToTick
 */
export const parsePointAsNoteOff = (noteOffPoint, spectrogram, secToTick, noteOnTime) => {
